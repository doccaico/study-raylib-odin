...
lblock :: proc() -> Block {
	...
	lblock.cells[0] = make([dynamic]Position, 4)
	...
	lblock.cells[1] = make([dynamic]Position, 4)
	...
	lblock.cells[2] = make([dynamic]Position, 4)
	...
	lblock.cells[3] = make([dynamic]Position, 4)
...
jblock :: proc() -> Block {
	...
	jblock.cells[0] = make([dynamic]Position, 4)
	...
	jblock.cells[1] = make([dynamic]Position, 4)
	...
	jblock.cells[2] = make([dynamic]Position, 4)
	...
	jblock.cells[3] = make([dynamic]Position, 4)
...
iblock :: proc() -> Block {
	...
	iblock.cells[0] = make([dynamic]Position, 4)
	...
	iblock.cells[1] = make([dynamic]Position, 4)
	append(&iblock.cells[1], position(0, 2))
	append(&iblock.cells[1], position(1, 2))
	append(&iblock.cells[1], position(2, 2))
	append(&iblock.cells[1], position(3, 1))

	iblock.cells[2] = make([dynamic]Position, 4)
	...
	iblock.cells[3] = make([dynamic]Position, 4)
...
oblock :: proc() -> Block {
	...
	oblock.cells[0] = make([dynamic]Position, 4)
...
sblock :: proc() -> Block {
	...
	sblock.cells[0] = make([dynamic]Position, 4)
	...
	sblock.cells[1] = make([dynamic]Position, 4)
	...
	sblock.cells[2] = make([dynamic]Position, 4)
	...
	sblock.cells[3] = make([dynamic]Position, 4)
...
tblock :: proc() -> Block {
	...
	tblock.cells[0] = make([dynamic]Position, 4)
	...
	tblock.cells[1] = make([dynamic]Position, 4)
	...
	tblock.cells[2] = make([dynamic]Position, 4)
	...
	tblock.cells[3] = make([dynamic]Position, 4)
...
zblock :: proc() -> Block {
	...
	zblock.cells[0] = make([dynamic]Position, 4)
	...
	zblock.cells[1] = make([dynamic]Position, 4)
	...
	zblock.cells[2] = make([dynamic]Position, 4)
	...
	zblock.cells[3] = make([dynamic]Position, 4)
